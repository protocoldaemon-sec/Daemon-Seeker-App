  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.subtitle}>Connect your wallet, fetch a nonce, and sign the message.</Text>

        <TouchableOpacity style={[styles.button, styles.secondary]} onPress={connectWallet}>
        ...
        <TouchableOpacity style={[styles.button, !address && styles.disabled]} onPress={getNonce} disabled={!address || loading}>
        ...
        {nonce ? (
          <>
            ...
            <TouchableOpacity style={[styles.button, styles.primary, (!signature || loading) && styles.disabled]} onPress={verify} disabled={!signature || loading}>
