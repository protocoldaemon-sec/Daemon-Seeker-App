        ...
        <section className="mt-6">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <Label htmlFor="theme-system" className="text-white/90">
                System
              </Label>
            </div>
            <div className="flex items-center gap-2">
              <RadioGroupItem value="light" id="theme-light" />
              <Label htmlFor="theme-light" className="text-white/90">
                Light
              </Label>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="space-y-4 text-sm">
            ...
            <div className="flex items-center gap-3">
              <Checkbox
                id="product"
                checked={product}
                onCheckedChange={(v) => setProduct(Boolean(v))}
              />
              <Label htmlFor="product" className="text-white/90">
                Product updates
              </Label>
            </div>
          </div>
